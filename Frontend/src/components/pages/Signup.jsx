          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="my-4 md:mb-5 flex flex-col sm:flex-row items-center gap-3">
              <figure className="w-[50px] h-[50px] md:w-[60px] md:h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
                <img
                  src={previewURL || "/default-avatar.png"} // Add a default avatar image
                  alt="Profile"
              ...
              <div className="relative w-full sm:w-[130px] h-[40px] md:h-[50px]">
                ...
                >
                  {imgLoading ? "Uploading..." : "Upload Photo"}
                  <input
                    type="file"
                    name="profilePhoto"
                    id="customFile"
            ...
            <div className="mt-6 md:mt-7">
              <button
                ...
                className="w-full bg-primaryColor text-white text-base md:text-[18px] leading-[30px] rounded-lg px-4 py-2 md:py-3 min-h-[45px] md:min-h-[50px] hover:bg-opacity-90 transition-all duration-300 disabled:bg-opacity-70 disabled:cursor-not-allowed"
              >
